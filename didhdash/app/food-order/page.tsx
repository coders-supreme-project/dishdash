  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-[1400px] mx-auto p-4 flex gap-4">
              ...
              <div className="grid grid-cols-3 gap-6">
                {orders.map((order) => (
                  <div key={order.id} className="bg-white p-4 rounded-xl">
                    <div className="flex gap-4">
                      <Image
                        src={order.items[0]?.image || DEFAULT_FOOD_IMAGE}
                      ...
                      />
                      <div>
                        <h3 className="font-semibold mb-1">{order.restaurant}</h3>
                        <div className="dish-price">${order.totalAmount.toFixed(2)}</div>
        ...
        {/* Right Sidebar and other components */}
      </div>
    </div>
  );
}